 ...
 *
 * If your CameraCapture is different, tell me — I will adapt.
 */
...
export default function FaceClockPage() {
  ...
  const [lastResult, setLastResult] = useState<FacePunchResult | null>(null);
  ...
  function detectBlink() {
    // Simple heuristic: brief video freeze / change
    // (true blink detection requires landmarks – this is MVP-safe)
